# import the flask and its componenets
from flask import *
import os
...
def signup():
    # extract the different details enteries on the form
    ...
    # The %s is a placeholder -> A placeholder it stands in place of actual values i.e we shall replace them later
